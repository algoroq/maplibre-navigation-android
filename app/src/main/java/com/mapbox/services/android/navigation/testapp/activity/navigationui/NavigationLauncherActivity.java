...
public class NavigationLauncherActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private void fetchRoute() {
        String fakeResponseJson = "{\"code\":\"Ok\",\"waypoints\":[{\"hint\":\"Hu0IkiDtCJITAAAAFAAAACoAAAAAAAAAyAMJQfarA0GabJJBAAAAAEcAAABGAAAAmQAAAAAAAAAOAAAAyYbcACiI6wK9htwAKIjrAgEAfxZkJ06_\",\"distance\":0.878529,\"location\":[14.452425,48.990248],\"name\":\"\"},{\"hint\":\"SEHajUtB2o0BAAAAYgAAAAAAAAAAAAAASefgPq7aKUIAAAAAAAAAAAMAAABjAQAAAAAAAAAAAAAOAAAAq4jcAESH6wKriNwAQofrAgAA7xBkJ06_\",\"distance\":0.222418,\"location\":[14.452907,48.99002],\"name\":\"Fr. Ondříčka\"},{\"hint\":\"P0HajQHtCJIBAAAAOQAAAAAAAAAAAAAAP9EqP_T0wUEAAAAAAAAAAAUAAADMAAAAAAAAAAAAAAAOAAAAbobcAFCF6wJthtwAUIXrAgAAfxZkJ06_\",\"distance\":0.073211,\"location\":[14.452334,48.98952],\"name\":\"Fr. Ondříčka\"}],\"routes\":[{\"legs\":[{\"steps\":[{\"intersections\":[{\"out\":0,\"entry\":[true],\"location\":[14.452425,48.990248],\"bearings\":[0]}],\"driving_side\":\"right\",\"geometry\":{\"coordinates\":[[14.452425,48.990248],[14.452425,48.990322]],\"type\":\"LineString\"},\"duration\":7,\"distance\":8.2,\"name\":\"\",\"weight\":2,\"mode\":\"walking\",\"maneuver\":{\"bearing_after\":0,\"bearing_before\":0,\"type\":\"depart\",\"location\":[14.452425,48.990248]}},{\"intersections\":[{\"out\":1,\"in\":2,\"entry\":[true,true,false],\"location\":[14.452425,48.990322],\"bearings\":[0,90,180]}],\"driving_side\":\"right\",\"geometry\":{\"coordinates\":[[14.452425,48.990322],[14.45292,48.990324]],\"type\":\"LineString\"},\"duration\":30.2,\"distance\":36.1,\"name\":\"\",\"weight\":8.4,\"mode\":\"walking\",\"maneuver\":{\"bearing_after\":88,\"location\":[14.452425,48.990322],\"type\":\"turn\",\"bearing_before\":0,\"modifier\":\"right\"}},{\"intersections\":[{\"out\":1,\"in\":2,\"entry\":[true,true,false],\"location\":[14.45292,48.990324],\"bearings\":[0,180,270]},{\"out\":2,\"in\":0,\"entry\":[false,true,true],\"location\":[14.452918,48.990236],\"bearings\":[0,45,180]}],\"driving_side\":\"right\",\"geometry\":{\"coordinates\":[[14.45292,48.990324],[14.452918,48.990236],[14.452913,48.99002]],\"type\":\"LineString\"},\"duration\":28.3,\"distance\":33.8,\"name\":\"\",\"weight\":7.9,\"mode\":\"walking\",\"maneuver\":{\"bearing_after\":180,\"location\":[14.45292,48.990324],\"type\":\"turn\",\"bearing_before\":88,\"modifier\":\"right\"}},{\"intersections\":[{\"in\":0,\"entry\":[true],\"location\":[14.452913,48.99002],\"bearings\":[0]}],\"driving_side\":\"right\",\"geometry\":{\"coordinates\":[[14.452913,48.99002],[14.452913,48.99002]],\"type\":\"LineString\"},\"duration\":0.3,\"distance\":0.4,\"name\":\"\",\"weight\":0.1,\"mode\":\"walking\",\"maneuver\":{\"bearing_after\":0,\"bearing_before\":180,\"type\":\"arrive\",\"location\":[14.452913,48.99002]}}],\"weight\":18.4,\"distance\":78.6,\"summary\":\"Fr. Ondříčka\",\"duration\":65.8},{\"steps\":[{\"intersections\":[{\"out\":0,\"entry\":[true],\"location\":[14.452907,48.99002],\"bearings\":[270]}],\"driving_side\":\"right\",\"geometry\":{\"coordinates\":[[14.452907,48.99002],[14.452327,48.990023]],\"type\":\"LineString\"},\"duration\":35.5,\"distance\":42.3,\"name\":\"Fr. Ondříčka\",\"weight\":9.8,\"mode\":\"walking\",\"maneuver\":{\"bearing_after\":270,\"bearing_before\":0,\"type\":\"depart\",\"location\":[14.452907,48.99002]}},{\"intersections\":[{\"out\":2,\"in\":1,\"entry\":[true,false,true],\"location\":[14.452327,48.990023],\"bearings\":[0,90,180]}],\"driving_side\":\"right\",\"geometry\":{\"coordinates\":[[14.452327,48.990023],[14.452331,48.989738],[14.452334,48.98952]],\"type\":\"LineString\"},\"duration\":46.9,\"distance\":55.9,\"name\":\"Fr. Ondříčka\",\"weight\":13.1,\"mode\":\"walking\",\"maneuver\":{\"bearing_after\":178,\"location\":[14.452327,48.990023],\"type\":\"continue\",\"bearing_before\":270,\"modifier\":\"left\"}},{\"intersections\":[{\"in\":0,\"entry\":[true],\"location\":[14.452334,48.98952],\"bearings\":[359]}],\"driving_side\":\"right\",\"geometry\":{\"coordinates\":[[14.452334,48.98952],[14.452334,48.98952]],\"type\":\"LineString\"},\"duration\":0,\"distance\":0,\"name\":\"Fr. Ondříčka\",\"weight\":0,\"mode\":\"walking\",\"maneuver\":{\"bearing_after\":0,\"bearing_before\":179,\"type\":\"arrive\",\"location\":[14.452334,48.98952]}}],\"weight\":22.9,\"distance\":98.3,\"summary\":\"Fr. Ondříčka\",\"duration\":82.4}],\"weight_name\":\"routability\",\"geometry\":{\"coordinates\":[[14.452425,48.990248],[14.452425,48.990322],[14.45292,48.990324],[14.452918,48.990236],[14.452907,48.99002],[14.452327,48.990023],[14.452331,48.989738],[14.452334,48.98952]],\"type\":\"LineString\"},\"weight\":41.3,\"distance\":176.9,\"duration\":148.2}]}";
        DirectionsResponse fakeResponse = DirectionsResponse.fromJson(fakeResponseJson);
                ...
                .getRoute(new SimplifiedCallback() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        if (validRouteResponse(response)) {
                            hideLoading();
                            Log.println(Log.DEBUG, "URL", response.raw().request().url().toString());
                            route = fakeResponse.routes().get(0);
                            if (route.distance() > 25d) {
                                launchRouteBtn.setEnabled(true);
                                mapRoute.addRoutes(fakeResponse.routes());
                                boundCameraToRoute();
                            } else {
