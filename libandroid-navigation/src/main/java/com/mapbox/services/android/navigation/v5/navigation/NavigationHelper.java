...
public class NavigationHelper {
    ...
    static double stepDistanceRemaining(Point snappedPosition, int legIndex, int stepIndex,
        ...
        for (List<Double> coordinate : steps.get(stepIndex).geometry().coordinates()) {
...
//    }
    ...
    public static List<Pair<StepIntersection, Double>> createDistancesToIntersections(List<Point> stepPoints,
        ...
        boolean lessThanTwoStepPoints;
        if (stepPoints != null) {
            lessThanTwoStepPoints = stepPoints.size() < TWO_POINTS;
        } else {
            lessThanTwoStepPoints = true;
        }
