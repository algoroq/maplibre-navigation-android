...
class MapboxNavigationNotification implements NavigationNotification {
    ...
    private void initialize(Context context, MapboxNavigation mapboxNavigation) {
        ...
        etaFormat = context.getString(R.string.notification_arrival_time_format);
    ...
    private void updateNotificationViews(RouteProgress routeProgress) {
        updateInstructionText(routeProgress.currentLegProgress());
...
//        }
    ...
    private void updateInstructionText(RouteLegProgress legProgress) {
        instructionText = legProgress.currentStep().maneuver().instruction();
        LegStep upComingStep = legProgress.upComingStep();
        if (upComingStep != null) {
            instructionText = upComingStep.maneuver().instruction();
        }
